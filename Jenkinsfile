pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://13.216.249.223:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://98.81.3.128:9090/springapp1"
            echo "✅ Frontend deployed: http://98.81.3.128:9090/frontapp1"
        }
        failure {
